...
"./vendor/4geo35/price-list/src/resources/views/admin/**/*.blade.php",
"./vendor/4geo35/price-list/src/resources/views/livewire/admin/**/*.blade.php",` в `tailwind.admin.config.js`, созданный в пакете `tailwindcss-theme`.
